      ...
      <div className="app-card flex flex-col justify-center px-8 py-12">
        <div className="space-y-6">
          <div className="text-center">
            <h1 className="text-app-black mb-6 font-normal text-lg">Make a difference! Share current/past job</h1>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-app-black mb-4 text-lg font-normal">3 Easy Questions. Shared an</p>
            </div>
            ...
            <div className="text-center mt-8">
              <p className="text-app-black text-lg">Don't worry, your boss won't know 😉</p>
            </div>
          </div>
        </div>
      </div>
