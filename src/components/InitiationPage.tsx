...
const InitiationPage: React.FC<InitiationPageProps> = ({ onComplete }) => {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center">
      <div className="app-card flex flex-col justify-center px-8 py-12 max-w-md mx-auto">
        <div className="space-y-6">
          <div className="text-center">
            <h1 className="text-app-black mb-6 font-normal text-lg leading-relaxed">
              Make A Difference! ❤️<br />
          ...
          <div className="text-center">
            <p className="text-app-black mb-4 text-lg leading-relaxed">
          ...
          <div className="text-center">
            <p className="text-app-black mb-4 text-lg font-normal leading-relaxed">
              3 Easy Questions.<br />
              Kept Anonymous 🤐
            </p>
          </div>
