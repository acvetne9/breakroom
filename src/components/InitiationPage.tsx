        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center space-x-3">
              <input type="text" inputMode="decimal" pattern="[0-9]*[.,]?[0-9]*" value={salary} onChange={handleSalaryChange} onBlur={checkForCompletion} placeholder="Pay Est. $" className="app-input text-center text-lg flex-1 !py-0 h-12" />
