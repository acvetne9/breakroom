...
import { SettingsPageProps } from '../types/app';
...
const SettingsPage: React.FC<SettingsPageProps> = ({ initialData, onJobUpdate }) => {
      ...
      <div className="app-card flex flex-col justify-center px-8 py-12">
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            {/* Location - Updated to match salary input layout */}
            <div>
              <div className="flex items-center space-x-3">
