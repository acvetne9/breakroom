...
const SettingsPage: React.FC<SettingsPageProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-start justify-center" style={{ paddingTop: "8dvh" }}>
      <div className="app-card p-6 animate-fade-in flex flex-col max-h-[80dvh] relative">
