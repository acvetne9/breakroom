    ...
    <div className={`flex items-center space-x-1 text-sm ${className}`} data-voting-component>
      ...
      {isOwner && (
        <div className="relative">
          ...
          {showDeleteConfirm && (
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[9999] bg-white rounded-xl border-2 border-yellow-400 shadow-lg p-4 max-w-xs w-full mx-4">
