...
const MapLibreMap: React.FC<MapLibreMapProps> = ({
  ...
  useEffect(() => {
    ...
    const businessesLayer = map.getLayer('businesses-layer');
    if (businessesLayer) {
      map.removeLayer('businesses-layer');
    }
    const businessesSource = map.getSource('businesses');
    if (businessesSource) {
      map.removeSource('businesses');
    }
    // Hide debug vector-tile businesses to avoid duplicate points
    const nycBusinessesLayer = map.getLayer('nyc-businesses');
    if (nycBusinessesLayer) {
