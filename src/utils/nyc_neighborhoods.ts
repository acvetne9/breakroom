...
export const nycNeighborhoodBoundaries = {
  ...
  "Brooklyn": {
    ...
    "Bedford-Stuyvesant": [
      { lat: 40.728, lon: -73.966 },
      { lat: 40.728, lon: -73.919 },
      { lat: 40.694, lon: -73.919 },
      { lat: 40.694, lon: -73.966 },
      { lat: 40.728, lon: -73.966 }
    ],
    "Crown Heights": [
      { lat: 40.694, lon: -73.979 },
      { lat: 40.694, lon: -73.942 },
      { lat: 40.668, lon: -73.942 },
      { lat: 40.668, lon: -73.979 },
      { lat: 40.694, lon: -73.979 }
    ],
    "Park Slope": [
