...
export const nycNeighborhoodBoundaries = {
  ...
  "Brooklyn": {
    "Williamsburg": [
      { lat: 40.718, lon: -73.996 },
      { lat: 40.718, lon: -73.936 },
      { lat: 40.728, lon: -73.936 },
      { lat: 40.728, lon: -73.950 },
      { lat: 40.722, lon: -73.960 },
      { lat: 40.715, lon: -73.978 },
      { lat: 40.710, lon: -73.990 },
      { lat: 40.710, lon: -73.996 },
      { lat: 40.718, lon: -73.996 }
    ],
    "Bushwick": [
      { lat: 40.694, lon: -73.905 },
      { lat: 40.710, lon: -73.905 },
      { lat: 40.710, lon: -73.936 },
      { lat: 40.718, lon: -73.936 },
      { lat: 40.718, lon: -73.932 },
      { lat: 40.710, lon: -73.920 },
      { lat: 40.694, lon: -73.920 },
      { lat: 40.694, lon: -73.905 }
    ],
    "Downtown Brooklyn": [
      { lat: 40.688, lon: -73.996 },
      { lat: 40.701, lon: -73.996 },
      { lat: 40.701, lon: -73.985 },
      { lat: 40.698, lon: -73.975 },
      { lat: 40.692, lon: -73.975 },
