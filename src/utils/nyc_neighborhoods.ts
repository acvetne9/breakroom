...
export const nycNeighborhoodBoundaries = {
  "Manhattan": {
    ...
    "Upper West Side": [
      ...
      { lat: 40.768, lon: -73.996 },
      { lat: 40.800, lon: -73.996 },
      { lat: 40.800, lon: -73.982 },
      { lat: 40.768, lon: -73.982 }
    ],
    "Harlem": [
      { lat: 40.800, lon: -73.996 },
      { lat: 40.800, lon: -73.949 },
      { lat: 40.850, lon: -73.949 },
      { lat: 40.850, lon: -73.996 },
      { lat: 40.800, lon: -73.996 }
    ],
    "Midtown": [
      { lat: 40.748, lon: -73.996 },
      { lat: 40.748, lon: -73.968 },
      { lat: 40.768, lon: -73.968 },
      { lat: 40.768, lon: -73.996 },
      { lat: 40.748, lon: -73.996 }
    ],
    "Greenwich Village": [
