...
export const nycNeighborhoodBoundaries = {
  ...
  "Brooklyn": {
    ...
    "Greenpoint": [
      ...
      { lat: 40.728, lon: -73.936 },
      { lat: 40.728, lon: -73.950 },
      { lat: 40.732, lon: -73.958 },
      { lat: 40.738, lon: -73.962 },
      { lat: 40.745, lon: -73.964 }
    ],
    "Bedford-Stuyvesant": [
      { lat: 40.728, lon: -73.959 },
      { lat: 40.728, lon: -73.936 },
      { lat: 40.718, lon: -73.936 },
      { lat: 40.710, lon: -73.936 },
      { lat: 40.701, lon: -73.936 },
      { lat: 40.694, lon: -73.936 },
      { lat: 40.694, lon: -73.950 },
      { lat: 40.701, lon: -73.959 },
      { lat: 40.710, lon: -73.959 },
      { lat: 40.718, lon: -73.959 },
      { lat: 40.728, lon: -73.959 }
    ],
    "Crown Heights": [
      { lat: 40.694, lon: -73.959 },
      { lat: 40.694, lon: -73.936 },
      { lat: 40.683, lon: -73.936 },
      { lat: 40.668, lon: -73.936 },
      { lat: 40.656, lon: -73.936 },
      { lat: 40.656, lon: -73.959 },
      { lat: 40.668, lon: -73.959 },
      { lat: 40.683, lon: -73.959 },
      { lat: 40.694, lon: -73.959 }
    ],
    "Park Slope": [
