...
export const nycNeighborhoodBoundaries = {
  ...
  "Brooklyn": {
    ...
    "Greenpoint": [
      { lat: 40.745, lon: -73.964 },
      { lat: 40.746, lon: -73.955 },
      { lat: 40.747, lon: -73.945 },
      { lat: 40.745, lon: -73.936 },
      { lat: 40.742, lon: -73.932 },
      { lat: 40.738, lon: -73.930 },
      { lat: 40.735, lon: -73.928 },
      { lat: 40.732, lon: -73.926 },
      { lat: 40.729, lon: -73.930 },
      { lat: 40.728, lon: -73.936 },
      { lat: 40.728, lon: -73.942 },
      { lat: 40.729, lon: -73.948 },
      { lat: 40.732, lon: -73.954 },
      { lat: 40.735, lon: -73.958 },
      { lat: 40.738, lon: -73.962 },
      { lat: 40.742, lon: -73.964 },
      { lat: 40.745, lon: -73.964 }
    ],
    "Bedford-Stuyvesant": [
      { lat: 40.708, lon: -73.957 },
      { lat: 40.708, lon: -73.950 },
      { lat: 40.707, lon: -73.940 },
      { lat: 40.705, lon: -73.930 },
      { lat: 40.702, lon: -73.925 },
      { lat: 40.698, lon: -73.922 },
      { lat: 40.695, lon: -73.920 },
      { lat: 40.694, lon: -73.925 },
      { lat: 40.694, lon: -73.935 },
      { lat: 40.695, lon: -73.945 },
      { lat: 40.698, lon: -73.952 },
      { lat: 40.702, lon: -73.955 },
      { lat: 40.705, lon: -73.957 },
      { lat: 40.708, lon: -73.957 }
    ],
    "Crown Heights": [
