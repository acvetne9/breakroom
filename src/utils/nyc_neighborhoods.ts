...
export const nycNeighborhoodBoundaries = {
  "Manhattan": {
    ...
    "Financial District": [
      { lat: 40.694, lon: -74.013 },
      { lat: 40.705, lon: -74.013 },
      { lat: 40.713, lon: -74.006 },
      { lat: 40.713, lon: -73.999 },
      { lat: 40.713, lon: -73.993 },
      { lat: 40.705, lon: -73.993 },
    ...
    "Lower East Side": [
      ...
      { lat: 40.715, lon: -73.975 },
      { lat: 40.718, lon: -73.971 },
      { lat: 40.722, lon: -73.968 },
      { lat: 40.722, lon: -73.945 },
      { lat: 40.715, lon: -73.945 },
      { lat: 40.708, lon: -73.945 },
      { lat: 40.701, lon: -73.950 },
      { lat: 40.705, lon: -73.975 },
