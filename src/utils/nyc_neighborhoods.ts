...
export const nycNeighborhoodBoundaries = {
  ...
  "Brooklyn": {
    ...
    "Bedford-Stuyvesant": [
      { "lat": 40.718, "lon": -73.964 },
      { "lat": 40.718, "lon": -73.936 },
      { "lat": 40.706, "lon": -73.936 },
      { "lat": 40.706, "lon": -73.964 },
      { "lat": 40.718, "lon": -73.964 }
    ],
    "Crown Heights": [
      { "lat": 40.675, "lon": -73.944 },
      { "lat": 40.675, "lon": -73.935 },
      { "lat": 40.663, "lon": -73.935 },
      { "lat": 40.663, "lon": -73.944 },
      { "lat": 40.675, "lon": -73.944 }
    ],
    "Greenpoint": [
      { "lat": 40.740, "lon": -73.959 },
      { "lat": 40.740, "lon": -73.949 },
      { "lat": 40.730, "lon": -73.949 },
      { "lat": 40.730, "lon": -73.959 },
      { "lat": 40.740, "lon": -73.959 }
    ],
    "Park Slope": [
