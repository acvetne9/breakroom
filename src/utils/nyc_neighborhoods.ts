...
export const nycNeighborhoodBoundaries = {
  "Manhattan": {
    ...
    "Financial District": [
      { lat: 40.694, lon: -74.018 },
      { lat: 40.715, lon: -74.015 },
      { lat: 40.720, lon: -74.010 },
      { lat: 40.720, lon: -73.995 },
      { lat: 40.715, lon: -73.990 },
      { lat: 40.708, lon: -73.985 },
      { lat: 40.701, lon: -73.985 },
      { lat: 40.694, lon: -73.990 },
      { lat: 40.694, lon: -74.000 },
      { lat: 40.694, lon: -74.018 }
    ],
    "Lower East Side": [
      { lat: 40.715, lon: -73.987 },
      { lat: 40.722, lon: -73.987 },
      { lat: 40.722, lon: -73.975 },
      { lat: 40.722, lon: -73.955 },
      { lat: 40.715, lon: -73.945 },
