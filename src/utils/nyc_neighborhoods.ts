...
export const nycNeighborhoodBoundaries = {
  ...
  "Brooklyn": {
    ...
    "Bedford-Stuyvesant": [
      ...
      { lat: 40.694, lon: -73.932 },
      { lat: 40.694, lon: -73.920 },
      { lat: 40.688, lon: -73.920 },
      { lat: 40.688, lon: -73.965 },
      { lat: 40.694, lon: -73.970 },
      { lat: 40.710, lon: -73.965 },
    ...
    "Crown Heights": [
      ...
      { lat: 40.694, lon: -73.920 },
      { lat: 40.694, lon: -73.932 },
      { lat: 40.688, lon: -73.940 },
      { lat: 40.675, lon: -73.940 },
      { lat: 40.668, lon: -73.932 },
      { lat: 40.668, lon: -73.920 },
      { lat: 40.675, lon: -73.915 },
      { lat: 40.688, lon: -73.920 }
    ],
    "Park Slope": [
