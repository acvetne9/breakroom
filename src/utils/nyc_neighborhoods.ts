...
export const nycNeighborhoodBoundaries = {
  "Manhattan": {
    ...
    "Upper West Side": [
      ...
      { lat: 40.780, lon: -74.002 },
      { lat: 40.790, lon: -74.008 },
      { lat: 40.800, lon: -74.014 },
    ...
    "Harlem": [
      { lat: 40.800, lon: -73.958 },
      { lat: 40.800, lon: -74.014 },
      { lat: 40.810, lon: -74.020 },
      { lat: 40.825, lon: -74.026 },
      { lat: 40.840, lon: -74.030 },
      { lat: 40.850, lon: -74.032 },
      { lat: 40.850, lon: -73.936 },
      { lat: 40.840, lon: -73.932 },
      { lat: 40.825, lon: -73.928 },
