...
type MapBoundsOrPolygon = MapBounds | [number, number][];
...
export const useViewportBusinesses = (searchFilters?: any, zoom: number = 12) => {
  ...
  const loadBusinessesInViewport = useCallback(async (bounds: MapBoundsOrPolygon, limit: number = 8000, isMoving: boolean = false) => {
